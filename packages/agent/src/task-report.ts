...
// (metadata + tool-call transcript + the agent's answer) to OUTPUT.
...
async function main() {
  ...
  const lines: string[] = [
    `# Agent Task Report`,
    ``,
    `> Generated by the Remote Browser MCP agent, driving a real Chrome through the bridge.`,
    ``,
    `| Field | Value |`,
    `|---|---|`,
    ...
    `| Model | ${model} |`,
    `| Bridge | ${BRIDGE_MCP_URL} |`,
    `| Tools available | ${bridge.toolCount()} |`,
